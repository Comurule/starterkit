...
router.post('/campaigns/:campaignId/update', updateCampaign);
...
router.post('/campaignData/create', createCampaignData);

router.post('/campaignData/:campaignDataId/update', updateCampaignData);
