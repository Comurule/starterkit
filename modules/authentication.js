  ...
  return async function (req, res, next) {
    ...
    let map={};
        ...
        */
        ...
        console.log('This is req.session.ret_data.status '+ req.session.ret_data.status);
        
        console.log('This is req.ret_data.status '+ req.ret_data.status);
        
          console.log('This is req.ret_data.error_code '+ req.ret_data.error_code);
          
          console.log('This is req.ret_data.message '+ req.ret_data.message);
        ...
        if(req.ret_data.status){
            ...
            console.log('Invalid request from User Module');
